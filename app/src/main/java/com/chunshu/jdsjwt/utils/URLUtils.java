...
//    public static final String APP_NAME    = "outdoor";
//
//    /**
//     * 生成推流地址
...
//     * @param streamId
//     * @param userId
//     * @param type type 0:RTC  1：HTTP 2:WEBRTC 3:RTMP
//     * @return
//     */
...
//        }else if(type == 3){
//            playUrl = RTMP + GenerateTestUserSig.PLAY_DOMAIN + File.separator + APP_NAME + File.separator + streamId + GenerateTestUserSig.getPlaySafeUrl(streamId);
//        }
//        return playUrl;
//    }
//}
